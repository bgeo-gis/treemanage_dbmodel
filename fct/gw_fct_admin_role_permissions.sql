-- Function: SCHEMA_NAME.gw_fct_admin_role_permissions()

-- DROP FUNCTION SCHEMA_NAME.gw_fct_admin_role_permissions();

CREATE OR REPLACE FUNCTION SCHEMA_NAME.gw_fct_admin_role_permissions()
  RETURNS void AS
$BODY$
